	    		...
	    		if (results != null) {
	    			...
	    			for (int i = 0; i < classes.length; i++) {  
		    			...
		    			if (results[index + 3 * i + 0] > results[index + 3 * i + 1]) {
		    				...
		    				message += "uComp Validation <b><font color=\"green\">POSITIVE</font></b>! The subclass \"" + fSubclass.getText() +
		    						"\" <b>is relevant</b> for the superclass \"" + classes[i] + "\"!";
		    				...
		    				if (results[index + 3 * i + 0] < results[index + 3 * i + 1]) {
			    				...
			    				message += "uComp Validation <b><font color=\"red\">NEGATIVE</font></b>! The subclass \"" + fSubclass.getText() +
			    						"\" <b>is not relevant</b> for the superclass \"" + classes[i] + "\"!";  		    					
		    				...
		    				// if the validation was undetermined
			    				...
			    				message += "uComp Validation <b>UNDETERMINED</b>! The subclass \"" + fSubclass.getText() +
			    						"\" <b>might or might not be relevant</b> for the superclass \"" + classes[i] + "\"!";
		    				}
		    			}
	    			}	    				    							    			
	    		}

...
public class GwapRelationValidation extends AbstractOWLObjectPropertyViewComponent {
	...
	public void initialiseView() throws Exception {
	    ...
	    cAllRelations.setSelected(true);
	    			...
	    			if (!fOntologyDomain.getText().equals("")) {
	    				...
	    				if (oprops.size() != 0) {
			    			...
			    			if (!(crowdflower == true && owlrelations.size() < 5)) {
		    					...
		    					// create job
			    				jobid = gwap.createJob(5, crowdflower, fOntologyDomain.getText(), subjects, objects, oprops, fInfo.getText(), numberOfJudgementsDesired,
			    						paymentPerAssignment);

		...
		for (OWLAnnotation anno : selectedEntity.getAnnotations(currentOntology, annoType)) {			
			try {
				...
				case 3:
					...
					break;
				case 4:
					System.out.println("My validation string is: "+ anno.getValue().toString());
					System.out.println("this should be: #gwapproperty:" + anno.getValue().toString().substring(1, 15));
				...
				case 6:
					System.out.println("My validation string is: "+ anno.getValue().toString());
					System.out.println("this should be: #gwappropertyrange:" + anno.getValue().toString().substring(1, 19));
					
					if (anno.getValue().toString().substring(1, 19).equals("#gwappropertyrange:")) {
						validating = true;
					}
					break;
				}
			...
			try {
				switch(validationType) {
					...
					case 4:
						...
						System.out.println("My validation string is: "+ com);
						System.out.println("this should be: #gwappropertyrange:domain=" + com.substring(1, 22));
					...
					case 6:
						// differ from "#gwapproperty:remove=true;" to extract info later
						System.out.println("My validation string is: "+ com);
						System.out.println("this should be: #gwappropertyrange:domain=" + com.substring(1, 26));
						
						if (com.substring(1, 26).equals("#gwappropertyrange:domain=")) {
							validating = true;
						}
				}
			}
			...
			try {
				switch(validationType) {
					...
					case 4:
						// differ from "#gwapproperty:remove=true;" to extract info later
						System.out.println("My validation string is: "+ com);
						System.out.println("this should be: #gwapproperty:domain=" + com.substring(1, 22));

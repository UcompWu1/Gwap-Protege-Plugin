...
public class GwapClassValidation extends AbstractOWLClassViewComponent {
	...
	private Box judgementsAndPriceBox ,buttonBox, statusInfoScrollBox, removeBox;
	private JLabel conceptLabel, domainLabel, infoLabel, numberOfJudgmentsLabel, paymentAmountLabel;
	...
	private JPanel judgementsPanel;
	...
	public void initialiseClassView() throws Exception {
	    ...
	    // CREATING THE CHECKBOX FOR THE JUDGEMENTS AND PAYMENTS HERE
	    			...
	    			if (!domainTextField.getText().equals("")) {
			    		...
			    		if (owlclasses.size() != 0) {			    			
			    			...
			    			if (!(crowdflower == true && owlclasses.size() < 5)) {
			    				...
			    				// create job
				    			jobid = gwapCommunication.createJob(1, crowdflower, domainTextField.getText(), classes, null, null, infoTextField.getText(), numberOfJudgementsDesired, paymentPerAssignment, 
				    					selectedGoldUnitsFileName);
